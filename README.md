...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1186&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-ggpubr-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-ggpubr` can be installed with `conda`:
...
```
mamba install r-ggpubr
```

It is possible to list all of the versions of `r-ggpubr` available on your platform with `conda`:
...
```
mamba search r-ggpubr --channel conda-forge
```
...
mamba repoquery search r-ggpubr --channel conda-forge

# List packages depending on `r-ggpubr`:
mamba repoquery whoneeds r-ggpubr --channel conda-forge

# List dependencies of `r-ggpubr`:
mamba repoquery depends r-ggpubr --channel conda-forge
```
